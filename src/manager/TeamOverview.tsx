...
export function TeamOverview() {
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <div>
        <h1 className="text-2xl font-bold text-ink-950 mb-1">오늘 확인이 필요해요</h1>
        <p className="text-ink-950/40 text-sm">
          Gangnam · {team.length}명 중 <span className="text-ink-950/70 font-medium">{attention.length}명</span> 주목 필요
        </p>
      </div>
      ...
      <Card className="bg-white/[0.03]">
        ...
        <p className="text-sm text-ink-950/60 leading-relaxed">{todaysPrinciple}</p>
      </Card>
    </div>
  )
}
